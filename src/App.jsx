...
function App() {
  ...
  const invoiceParse = async () => {
    try {
      ...
      fd.append('file', file);
      let response = await fetch('http://13.233.133.188:8000/parse_invoice_ocr/', { method: 'POST', body: fd })
          ...
          <div className='flex flex-col gap-5'>
              ...
              <section className='flex flex-col md:flex-row gap-3 justify-between w-full'>
                <div>
                  <div className='flex flex-col w-full gap-1'>
                    ...
                    <input type='text' id='invoice_number' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Invoice Number' value={invoiceData1.invoice_number} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="invoice_date" className='text-sm text-[#3b3b3b]'>Invoice Date</label>
                    <input type='text' id='invoice_date' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Invoice Date' value={invoiceData1.invoice_date} />
                  </div>
                </div>
                <div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="total_tax" className='text-sm text-[#3b3b3b]'>Total Tax</label>
                    <input type='text' id='total_tax' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Total Tax' value={invoiceData1.total_tax} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="invoice_amount" className='text-sm text-[#3b3b3b]'>Invoice Amount</label>
                    <input type='text' id='invoice_amount' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Invoice Amount' value={invoiceData1.invoice_amount} />
                  </div>
                </div>
              </section>
            </section>
              ...
              <div className='flex flex-grow flex-col'>
                ...
                <section className='flex flex-grow flex-col p-2 border-slate-400 border rounded-md shadow-lg'>
                  <div className='flex flex-col w-full gap-1'>
                    ...
                    <input type='text' id='buyer_name' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Buyer Name/Consignee' value={invoiceData1.buyer_name} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="buyer_address" className='text-sm text-[#3b3b3b]'>Buyer Address</label>
                    <input type='text' id='buyer_address' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Buyer Address' value={invoiceData1.buyer_address} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="buyer_phone_number" className='text-sm text-[#3b3b3b]'>Buyer Phone Number</label>
                    <input type='text' id='buyer_phone_number' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Buyer Phone Number' value={invoiceData1.buyer_phone_number} />
                  </div>
                </section>
              </div>
              <div className='flex flex-grow flex-col'>
                ...
                <section className='flex flex-grow flex-col p-2 border-slate-400 border rounded-md shadow-lg'>
                  <div className='flex flex-col w-full gap-1'>
                    ...
                    <input type='text' id='seller_name' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Seller Name' value={invoiceData1.seller_name} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="seller_address" className='text-sm text-[#3b3b3b]'>Seller Address</label>
                    <input type='text' id='seller_address' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Seller Address' value={invoiceData1.seller_address} />
                  </div>
                  <div className='flex flex-col w-full gap-1'>
                    <label htmlFor="seller_phone_number" className='text-sm text-[#3b3b3b]'>Seller Phone Number</label>
                    <input type='text' id='seller_phone_number' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Seller Phone Number' value={invoiceData1.seller_phone_number} />
                  </div>
                </section>
              </div>
            </section>
            <section className='flex flex-grow flex-col p-2 border-slate-400 border rounded-md shadow-lg'>
              <div className='flex flex-col w-full gap-1'>
                ...
                {
                  typeof invoiceData1['Items purchased'] === 'object' &&
                  typeof invoiceData1['Items purchased'] !== 'string' &&
                  Array.isArray(invoiceData1['Items purchased']) &&
                  typeof invoiceData1['Items purchased'][0] === 'object' &&
                  typeof invoiceData1['Items purchased'][0] !== 'string' &&
                  !Array.isArray(typeof invoiceData1['Items purchased'][0]) &&
                  <TableMultiComponent items={invoiceData1['Items purchased']} />
                }
                {typeof invoiceData1['Items purchased'] === 'object' && typeof invoiceData1['Items purchased'] !== 'string' ?
                  Array.isArray(invoiceData1['Items purchased']) ?
                    invoiceData1['Items purchased'].map((item, index) => {
                    ...
                    <TableSingleComponent item={invoiceData1['Items purchased']} />
                  : typeof invoiceData1['Items purchased'] === 'string' ? <></> :
                    Object.entries(invoiceData1['Items purchased']).map(([k, v]) => {
                      return <p key={k}>The key {k} has a value of {v}</p>
                    })}
                {/* String */}
                {typeof invoiceData1['Items purchased'] === 'string' && <input type='text' id='Items purchased' className='w-full p-2 bg-[#f9f9f9] border-b border-[#3b3b3b] text-[#3b3b3b] placeholder:text-[#3b3b3b]' placeholder='Items purchased' value={invoiceData1['Items purchased']} />}
